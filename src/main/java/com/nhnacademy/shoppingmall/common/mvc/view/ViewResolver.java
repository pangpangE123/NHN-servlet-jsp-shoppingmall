...
public class ViewResolver {
    ...
    public boolean isRedirect(String viewName) {
        ...
        // 리다이렉트 요청 예시 : REDIRECT: /WEB-INF/views/login.do

        String lowerViewName = viewName.toLowerCase();
        return lowerViewName.contains(REDIRECT_PREFIX);
    }
    ...
    public boolean isAdmin(String viewName) {
        return viewName.contains(ADMIN_PATH);
    }
}
